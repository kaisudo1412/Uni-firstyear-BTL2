...
int main(int argc, char ** argv) {
    ...
    if (argc == 1) {
        file_armyknights = "C:/Users/ADMIN/Documents/Programming fundamentals/BTL2/tc1_armyknights"; // hard-code
        file_events = "C:/Users/ADMIN/Documents/Programming fundamentals/BTL2/tc1_events";
    }
    else if (argc == 3) {
